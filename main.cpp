...
int main(){ 
    ...
    cout << "  -> Validando os set's e get's" << endl << endl;

    cout << "Ponto 1: "; P1.print();
    cout << "Ponto 2: "; P2.print();
    cout << "Ponto 3: "; P3.print();
    ...
    cout << endl << "  -> Validando os metodos" << endl << endl;

    cout << "Distancia do P1 a origem: "<< P1.distToOrig() << endl;
    cout << "Distancia do P2 ao P3: "<< P2.distTo(P3) << endl;
    P3.sumOf(P2);
    cout << "Soma as coordenadas de P2 ao P3: "; P3.print();
    Ponto2D P4 = P1.sumOfTwoPoints(P2);
    cout << "Novo ponto P4 baseado em (P2+P1): "; P4.print(); cout << endl;
